...
EOL = "EOL\nLumiere-ubot v{}, Copyright © 2021-2022 Lumiere• <https://github.com/NotLumiere>"
MSG_BLACKLIST = "MAKANYA GA USAH BERTINGKAH GOBLOK, USERBOT {} GUA MATIIN NAJIS BANGET DIPAKE JAMET KEK LU.\nLumiere-ubot v{}, Copyright © 2023-2025 Lumiere• <https://github.com/NotLumiere>"
...
def multiayiin():
    #if 1329377873 not in DEVS:
        LOGS.warning(EOL.format(version))
        sys.exit(1)
    if -1001876092598 not in GBL:
        LOGS.warning(EOL.format(version))
        sys.exit(1)
    if 1329377873 not in DEFAULT:
        LOGS.warning(EOL.format(version))
        sys.exit(1)
    failed = 0
    if STRING_SESSION:
